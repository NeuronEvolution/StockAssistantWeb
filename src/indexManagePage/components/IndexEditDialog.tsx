        ...
        return (
            <Dialog open={!this.state.closed}>
                    ...
                    <List style={{width: '200px'}}>
                        ...
                        <ListItem key={'evalWeight'} style={itemStyle}>
                            <TextField
                                ...
                                onChange={(e) => {
                                    let index = this.state.indexEditing;
                                    index.evalWeight = parseInt(e.target.value, 36);
                                    this.setState({indexEditing: index});
                                }}
                            />
                        </ListItem>
                        <ListItem key={'aiWeight'} style={itemStyle}>
                            <TextField
                                ...
                                onChange={(e) => {
                                    let index = this.state.indexEditing;
                                    index.aiWeight = parseInt(e.target.value, 36);
                                    this.setState({indexEditing: index});
                                }}
                            />
                        </ListItem>
                ...
                <DialogActions>
                    ...
                    <Button
                        onClick={() => {
                            this.props.onIndexSave(
                                this.props.adding,
                                this.state.indexEditing,
                                this.props.indexEditing.name);
                            this.setState({closed: true});
                        }}
                    >
                        确定
